package com.glengarry.app.presentation.fashion.component
...
@Composable
fun DetailFashionHeader(
    modifier: Modifier = Modifier,
    details: FashionDetail
) {
    ...
    Column(
        ...
        AsyncImage(
            ...
            placeholder = painterResource(id = R.drawable.logo_fashion),
            error = painterResource(id = R.drawable.logo_fashion),
            modifier = Modifier
                .fillMaxWidth()
                .size(200.dp)
...
@Preview
@Composable
fun DetailFashionHeaderPreview() {
    GlengarryTheme {
        Surface {
