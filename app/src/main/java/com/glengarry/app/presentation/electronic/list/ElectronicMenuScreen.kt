package com.glengarry.app.presentation.electronic.list
...
fun ElectronicMenuScreen(
    ...
    val onItemClick: (ServiceItem) -> Unit = {
        navigateToDetailElectronicScreen()
    }
...
@Preview
@Composable
fun ElectronicMenuScreenPreview() {
    GlengarryTheme {
        Surface {
